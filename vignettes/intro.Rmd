...
__StatComp22036__ is a simple R package developed for project of StatComp. Three functions are considered, namely, g_lasso (group lasso variables selection), _arima_ (water supply time series prediction).
...
### an example from generated data
```{r}
